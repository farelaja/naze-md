/**
   * Base Ori < Iman / ManzEdtz >
   * Penambahan Banyak Fitur keren & perbaiki bug di sc naze: Oleh: ManzEdtz
...
async function startNaze() {
    ...
    naze.ev.on('messages.upsert', async chatUpdate => {
        ...
        require("./iman")(naze, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
